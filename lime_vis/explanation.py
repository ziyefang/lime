...
class Explanation(object):
    ...
    def show_in_notebook(self,
        ...
        #from IPythohcore.display import display, HTML
        lime_vis = self.as_html(labels=labels,
                                  predict_proba=predict_proba,
                                  show_predicted_value=show_predicted_value,
                                  **kwargs)
       # display(HTML(lime_vis))
        main_directory = os.getcwd()
        with open('lime_visualizaiton.html', 'w', encoding='utf-8') as f:
            f.write(lime_vis)
